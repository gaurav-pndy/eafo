  ...
  return (
    <div className="relative overflow-hidden bg-[#f2f3f8] py-16">
      ...
      <p className="text-center text-[#001554] max-w-6xl mx-auto text-xl mb-6">
        Для участников, заинтересованных в посещении отдельных блоков основной
        программы, предусмотрена возможность участия в тематических семинарах
        продолжительностью от 1 дня. Этот формат обеспечивает гибкость
        планирования и предоставляет возможность участия в

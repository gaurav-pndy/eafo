  ...
  return (
    <div className="relative overflow-hidden bg-[#f2f3f8] py-16">
      ...
      <p className="text-center text-[#001554] max-w-6xl mx-auto text-xl mb-6">
        Если Вас заинтересовали только отдельные блоки программы, Вы можете
        принять участие в выбранных Вами тематических семинарах, которые
        наиболее соответствуют Вашим профессиональным целям и интересам.
      </p>

...
const prizeList = [
  {
    icon: <FaGraduationCap className="text-5xl text-blue-900" />,
    titleKey: "Awards.grand.cards.0.title",
    descKey: "Awards.grand.cards.0.desc",
  },
  {
    icon: <FaPlaneDeparture className="text-5xl text-blue-900" />,
    titleKey: "Awards.grand.cards.1.title",
    descKey: "Awards.grand.cards.1.desc",
  },
  {
    icon: <FaUniversity className="text-5xl text-blue-900" />,
    ...
    <div id="grand-prize" className="mb-16">
      <div className="text-center mb-12 flex flex-col items-center justify-center">
        <div className="flex items-center justify-center w-20 h-20 rounded-full  ">
          <FaTrophy className="text-7xl text-yellow-500" />
        </div>
        <h2 className="text-3xl font-bold text-blue-900">
          {t("Awards.grand.title")}
        </h2>
        <p className="text-gray-700 mt-2">{t("Awards.grand.subtitle")}</p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {prizeList.map((item, index) => (
          ...
          >
            <div className="text-center  w-fit mx-auto mb-4">{item.icon}</div>
